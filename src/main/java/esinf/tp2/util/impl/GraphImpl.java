...
public class GraphImpl<V, E> implements Graph<V, E>
{
     ...
     *
     * @param directed Whether it's directed or not.
     */
    ...
    public Iterable<Edge<V, E>> edges()
    {
        ...
        {
            Iterable<Edge<V, E>> iterable = vertex.getAllOutEdges();
    ...
    public boolean insertEdge(V vOrig, V vDest, E eInf, int eWeight)
    {
    ...
    {
        GraphImpl<V, E> newObject = new GraphImpl<>(this.isDirected);
    ...
    public boolean equals(Object otherObj)
    {
        ...
        if (otherObj == null || !(otherObj instanceof GraphImpl))
            return false;

        GraphImpl<V, E> otherGraph = (GraphImpl<V, E>) otherObj;
    ...
    public String toString()
    {
        ...
        if (numVert == 0)
        {
            s = "\nGraphImpl not defined!!";
        } else
        {
            s = "GraphImpl: " + numVert + " vertices, " + numEdge + " edges\n";
            for (Vertex<V, E> vert : vertices.values())
                s += vert + "\n";
        }
        return s;
